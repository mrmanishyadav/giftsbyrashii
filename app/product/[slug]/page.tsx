    ...
    <StorefrontFrame>
      <main className="product-page shell">
        ...
        <section id="reviews" className="reviews-section">
          ...
          <div className="managed-reviews">{reviews.length ? reviews.map((review) => <blockquote key={review.id}>“{review.body}”<cite>— {review.title} · {'★'.repeat(review.rating)}</cite></blockquote>) : <blockquote>“The packaging felt so premium and the handwritten note made it wonderfully personal.”<cite>— Verified GiftsByRashii customer</cite></blockquote>}</div>
        </section>
